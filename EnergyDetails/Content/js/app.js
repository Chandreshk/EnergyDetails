(function ($, window, document, undefined) {
	...
	$.extend(Plugin.prototype, {
		...
		//    $(this.element).find('.weather__checkbox').attr('src', `Content/img/dialog_checkbox${this.settings.fixLocation ? '_selected' : ''}.png`);
		//},
		...
		_render: function(obj) {
			...
			if (obj) {
				...
				<span class ="weather__name-city" title="Click to select another city">${obj.name}, ${obj.country}</span><br><br>
				...
				.css(`background`, `url("Content/img/${obj.icon}.jpg")`)
